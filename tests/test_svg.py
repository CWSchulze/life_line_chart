from life_line_chart import AncestorChart, DescendantChart, get_gedcom_instance_container
import pytest
import os
try:
...
def test_generate_svg_file():
    ...
    chart = AncestorChart(instance_container=lambda: get_gedcom_instance_container(
        os.path.join(os.path.dirname(__file__), 'autogenerated.ged')))
...
def test_generate_svg_update_interface_descendant():
    chart = DescendantChart(instance_container=lambda: get_gedcom_instance_container(
        os.path.join(os.path.dirname(__file__), 'autogenerated.ged')))
